!function (l) {
    ...
    var m = null, q = parseInt(-7 * Math.random() + 9);
    p.prototype = {
        config: {musicList: [], defaultVolume: .7, defaultIndex: q}, createListDom: function () {
            var a = 0, c = "<ul>";
            for (a; a <
            ...
            0 >= a && (a = 0);
            this.currentMusic = a;
            var c = this.musicList[a], b = this, d = function () {
            ...
            this.musicDom.title.innerHTML = "<strong>" + c.title + "</strong><small>" + c.singer +
                "</small>";
            var c = document.querySelectorAll(".m-music-list-wrap li"), e = 0;
            for (e; e < this.musicLength; e++)e == a ? h(c[e], "current") : g(c[e], "current");
            this.audioDom.addEventListener("canplay", d, !1);
            this.play()
        }, setVolume: function (a) {
            var c = this.musicDom.volume, b = c.volumeEventer.offsetHeight || 50;
            0 >= a && (a = 0);
            1 <= a && (a = 1);
            ...
            var a = this.currentMusic, c = this.musicLength, b = 0, d = [];
            for (b; c > b; b++)b != a && d.push(b);
            a = parseInt(Math.random() * d.length);
            return d[a]
        }, playByMode: function (a) {
            var c = this.playMode, b = this.currentMusic, d = this.musicLength, e = b;
        ...
        action: function () {
            var a = this, c = this.musicDom.volume, b = this.musicDom.button;
            this.audioDom.addEventListener("timeupdate", function () {
                if (!isNaN(this.duration)) {
                    var b = n(this.currentTime), c = n(this.duration), d = this.currentTime / this.duration * a.musicDom.bufferProcess.parentNode.offsetWidth;
            ...
            var d = document.querySelectorAll(".m-music-list-wrap li"), e = 0;
